...
# Set the API key
openai.api_key = "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"

# Define the prompt
prompt = "Group this paragraph into related content based on sentences in bullet points: " + summary
